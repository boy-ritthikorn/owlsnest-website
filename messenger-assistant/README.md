...
- รับคำตอบที่ทีมส่งจาก Facebook โดยตรง เก็บเป็นบริบท และปิดร่างที่ค้างเพื่อป้องกันตอบซ้ำ
- คำตอบจากทีมจะเป็นตัวอย่างให้ AI ได้ต่อเมื่อเจ้าของกดอนุมัติใน Dashboard
- ไม่ยืนยันโต๊ะว่างหรือข้อมูลที่ไม่มีในฐานความรู้
- ไม่ส่งข้อความอัตโนมัติในเวอร์ชันแรก
- ตัวอย่างที่อนุมัติใช้เลียนแบบสำนวนเท่านั้น ข้อมูลราคา โปรโมชั่น เวลา และโต๊ะว่างยังยึดฐานความรู้ของร้าน
